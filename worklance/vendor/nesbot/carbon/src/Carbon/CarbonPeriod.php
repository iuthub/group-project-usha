...
class CarbonPeriod implements Iterator, Countable, JsonSerializable
{
     ...
     * @example
     * ```
     * Carbon::create('2021-11-29')->daysUntil('2021-12-24')->forEach(function (Carbon $date) {
     *   echo $date->diffInDays('2021-12-25')." days before Christmas!\n";
     * });
     * ```
     *
     * @param callable $callback
     ...
     * @example
     * ```
     * $period = Carbon::create('2021-11-29')->daysUntil('2021-12-24');
     * echo implode("\n", iterator_to_array($period->map(function (Carbon $date) {
     *   return $date->diffInDays('2021-12-25').' days before Christmas!';
     * })));
     * ```
     *
     * @param callable $callback
